...
static const char *dmi_chassis_type_names[__DMI_CHASSIS_TYPE_COUNT] =
{
    ...
    [DMI_CHASSIS_TYPE_HAND_HELD]           = "Hand held",
    ...
    [DMI_CHASSIS_TYPE_MAIN_SERVER]         = "Main server chassis",
    [DMI_CHASSIS_TYPE_EXPANSION]           = "Expansion chassis",
    [DMI_CHASSIS_TYPE_SUB_CHASSIS]         = "Sub-chassis",
    [DMI_CHASSIS_TYPE_BUS_EXPANSION]       = "Bus expansion chassis",
    [DMI_CHASSIS_TYPE_PERIPHERAL]          = "Peripheral chassis",
    [DMI_CHASSIS_TYPE_RAID]                = "RAID chassis",
    [DMI_CHASSIS_TYPE_RACK_MOUNT]          = "Rack-mount chassis",
    [DMI_CHASSIS_TYPE_SEALED_CASE_PC]      = "Sealed-case PC",
    [DMI_CHASSIS_TYPE_MULTI_SYSTEM]        = "Multi-system chassis",
    [DMI_CHASSIS_TYPE_COMPACT_PCI]         = "Compact PCI",
    [DMI_CHASSIS_TYPE_ADVANCED_TCA]        = "Advanced TCA",
    [DMI_CHASSIS_TYPE_BLADE]               = "Blade",
    [DMI_CHASSIS_TYPE_BLADE_ENCLOSURE]     = "Blade enclosure",
...
static const char *dmi_chassis_state_names[__DMI_CHASSIS_STATE_COUNT] =
{
...
{
    return dmi_name(dmi_chassis_state_names, value, __DMI_CHASSIS_STATE_COUNT);
}
