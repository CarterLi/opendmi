...
//
#ifndef OPENDMI_TABLE_SYSTEM_BOOT_H
#define OPENDMI_TABLE_SYSTEM_BOOT_H
...
/**
 * @brief System boot information table (type 32).
 */
 ...
 */
extern const dmi_table_spec_t dmi_system_boot_table;
 ...
 * @internal
 */
dmi_system_boot_t *dmi_system_boot_decode(const dmi_table_t *table, dmi_version_t *plevel);
...
#endif // !OPENDMI_TABLE_SYSTEM_BOOT_H
